        ...
        if (!cancelled) {
          ...
          toast({
            ...
            description:
              ...
              'reactdjango could not load your current subscription right now.',
            variant: 'warning',
            duration: 4000,
          })
        }
  ...
  const handleBkashRenewal = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          error.response?.data?.detail ||
          'reactdjango could not start the bKash renewal flow right now.',
        variant: 'error',
        duration: 4500,
      })
  ...
  const handleCancelSubscription = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          error.response?.data?.detail ||
          'reactdjango could not update the subscription right now.',
        variant: 'error',
        duration: 4500,
      })
    } finally {
