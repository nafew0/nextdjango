        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              {atLimit
                ? `You've reached the item cap on the ${usage?.plan?.name || 'Free'} plan. Upgrade to create more.`
                : `You're approaching the item cap on the ${usage?.plan?.name || 'Free'} plan. Upgrade before you run out of slots.`}
            </p>
          </div>
