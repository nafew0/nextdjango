...
function GoogleIcon(props) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path
        fill="#EA4335"
        d="M12 10.2v3.96h5.5c-.24 1.28-.97 2.36-2.06 3.1l3.32 2.58c1.94-1.78 3.04-4.4 3.04-7.53 0-.68-.06-1.34-.18-1.98H12z"
      />
      <path
        fill="#34A853"
        d="M12 22c2.7 0 4.97-.9 6.63-2.43l-3.32-2.58c-.92.62-2.1.99-3.31.99-2.54 0-4.7-1.72-5.48-4.03l-3.43 2.64A10 10 0 0 0 12 22z"
      />
      <path
        fill="#4A90E2"
        d="M6.52 13.95A6.02 6.02 0 0 1 6.2 12c0-.68.12-1.34.32-1.95L3.1 7.4A10 10 0 0 0 2 12c0 1.62.39 3.16 1.1 4.6l3.42-2.65z"
      />
      <path
        fill="#FBBC05"
        d="M12 5.98c1.47 0 2.8.5 3.84 1.48l2.88-2.88C16.96 2.96 14.7 2 12 2A10 10 0 0 0 3.1 7.4l3.42 2.65C7.3 7.7 9.46 5.98 12 5.98z"
      />
    </svg>
  )
}
...
export default function SocialLoginButtons({ nextPath = '/dashboard' }) {
  ...
  const handleSocialLogin = async (providerId) => {
    ...
    try {
      ...
      const detail = error.response?.data?.detail || error.message || 'Could not start social login.'
